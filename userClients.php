    ...
    <main>
        ...
        <?php 
            if (!empty($_SESSION["email"])) {
                ...
                <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-nav">
                            <a class="nav-link" aria-current="page" href="dashboard.php">Anzeige aller Kunden</a>
                            <a class="nav-link active" href="userClients">Anzeige meiner Kunden</a>
                ...
                <?php
$stmt = $pdo->prepare("SELECT * FROM `client` WHERE email = '".$_SESSION['email']."'");
$stmt->execute();
...
<table class="table">
    ...
    <tbody>
        ...
        echo "<td><a class='btn btn-primary' href='edit.php?id=". $result[$i]['company_id'] . "'>bearbeiten</a></td>";
        echo "<td><a class='btn btn-danger' href='delete.php?id=". $result[$i]['company_id'] . "'>löschen</a></td>";
        echo"</tr>";
        };
       ?>
    </tbody>
